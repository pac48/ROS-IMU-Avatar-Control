...
% exercise = 'Swipeleft'
exercise_file = ['data/Fast' exercise 'Data.mat']
hand_file = ['data/' exercise 'HandOutputFastTest.mat']
upper_file = ['data/' exercise 'UpperOutputFastTest.mat']
lower_file = ['data/' exercise 'LowerOutputFastTest.mat']
