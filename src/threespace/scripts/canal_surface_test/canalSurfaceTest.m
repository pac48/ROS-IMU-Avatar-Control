...
% exercise = 'Swipeleft'
exercise_file = ['data/' exercise 'DataTest.mat']
hand_file = ['data/' exercise 'HandOutputTest.mat']
upper_file = ['data/' exercise 'UpperOutputTest.mat']
lower_file = ['data/' exercise 'LowerOutputTest.mat']
...
for(i = 2:numDemos)
    ...
    upperset{21} = [upperset{21} ; upper_ang_set{i}];
    ...
    lowerset{21} = [lowerset{21} ; lower_ang_set{i}];
    ...
    handset{21} = [handset{21} ; hand_ang_set{i}];
end
max_
